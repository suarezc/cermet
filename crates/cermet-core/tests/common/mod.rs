...
/// `read_job_log`, and the release plane's three among them), thirty-six Stripe, and two Vercel
/// (the relay deploy and the scoped list read).
pub const VENDORED_ONTOLOGY_RECORDS: usize = 65;
...
/// the same set.
pub const PRODUCT_VERBS: usize = 75;
