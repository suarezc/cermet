...
/// `read_job_log`, and the release plane's three among them), thirty-two Stripe, and two Vercel
/// (the relay deploy and the scoped list read).
pub const VENDORED_ONTOLOGY_RECORDS: usize = 61;
...
/// the same set.
pub const PRODUCT_VERBS: usize = 71;
